...
function MenuEditor(idSelector, options) {
    ...
    var settings = {
        ...
        listOptions: { 
            ...
            opener: {
                as: 'html',
                close: '<i class="fa fa-folder-open"></i>',
                open: '<i class="fa fa-folder"></i>',
    ...
    function TButtonGroup() {
        ...
        var $btnOut = TButton({classCss: 'btn btn-secondary btn-sm btnOut btnMove', text: '<i class="fa fa-arrow-right fa-rotate-180 clickable"></i>'});
        var $btnIn = TButton({classCss: 'btn btn-secondary btn-sm btnIn btnMove', text: '<i class="fa fa-arrow-right clickable"></i>'});
